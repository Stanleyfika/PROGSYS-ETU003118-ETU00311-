...
public class SousServeur2 extends Thread {
    ...
    private static void loadConfig() {
        ...
        try (FileInputStream fis = new FileInputStream("server_config.txt")) {
            ...
            ipSousServeur = properties.getProperty("sousServeur2_ip", "127.0.0.1");
            portSousServeur = Integer.parseInt(properties.getProperty("sousServeur2_port", "5001"));
            dossierSousServeur = properties.getProperty("dossierDestination2", "./server_files/s1");
...
private void receiveAndSaveFilePart(Socket clientSocket) throws IOException {
    ...
    public static void main(String[] args) {
        SousServeur2 sousServeur = new SousServeur2(); // Création de l'instance du sous-serveur
